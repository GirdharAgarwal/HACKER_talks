    ...
    return(
        ...
        <div className="disp-box">
           <div className="head-content">
               {postData.title}
               <button type="button" className="disp-button clicked" name="Delete" onClick={postDelete}><MdDelete size={25}/></button>
               <button type="button" className="disp-button clicked" name="Edit" onClick={postEdit}><BiEdit size={25}/></button>
           </div>
        ...
        <form className="post-form">
            ...
            <button type="submit" className="mb-3 mx-auto btn btn-primary" onClick={updatePost}>Update Post</button>
